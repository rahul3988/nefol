...
import { 
  Dashboard, Orders, Customers, Users, Categories, Settings, Login, Products,
...
export default function App() {
  useEffect(() => {
    ...
    socketService.subscribe('order_created', (data) => {
      console.log('New order created:', data)
      // You can add notification logic here
    })
    
    socketService.subscribe('order_updated', (data) => {
      console.log('Order updated:', data)
      // You can add notification logic here
    })
    
    socketService.subscribe('user_profile_updated', (data) => {
      console.log('User profile updated:', data)
      // You can add notification logic here
    })
    
    socketService.subscribe('delivery_status_updated', (data) => {
