  ...
  const [features] = useState<AIFeature[]>([
    {
      ...
      description: 'AI-powered product suggestions based on customer behavior',
      status: 'active',
      impact: 'high',
    ...
    },
    {
      ...
      description: 'Automated price optimization based on demand and competition',
      status: 'active',
      impact: 'high',
      category: 'automation',
      metrics: {
  ...
  const [tasks] = useState<AITask[]>([
    {
      ...
      description: 'Analyzing customer patterns for better recommendations',
      status: 'running',
      progress: 65,
    ...
    },
    {
      ...
      description: 'Updating product prices based on market conditions',
      status: 'completed',
      progress: 100,
      estimatedTime: '30 minutes',
      results: { revenueIncrease: 12.5, ordersAffected: 1250 }
    },
    {
      id: '3',
      name: 'Inventory Prediction',
      description: 'Predicting stock requirements for next month',
      status: 'pending',
      progress: 0,
                          ...
                          {Object.entries(task.results).map(([key, value]) => (
                            <div key={key} className="flex justify-between">
                              ...
                              <span className="font-semibold text-green-800 dark:text-green-200">
                                {typeof value === 'number' ? (key.includes('Increase') ? `+${value}%` : value.toLocaleString()) : value}
                              </span>
                            </div>
                          ))}
                        </div>
