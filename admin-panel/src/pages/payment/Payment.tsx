...
const Payment = () => {
  ...
  useEffect(() => {
    ...
    const mockPaymentReport: PaymentReport = {
      period: 'January 2024',
      ...
      paymentMethodBreakdown: [
        { method: 'Credit Card', count: 80, amount: 12000 },
        { method: 'PayPal', count: 40, amount: 8000 },
        { method: 'Razorpay', count: 30, amount: 5000 }
      ]
    }
    setPaymentReport(mockPaymentReport)
  }, [])
