    ...
    const mockInvoices: Invoice[] = [
      {
        ...
        items: [
          { id: '1', productName: 'Face Cleanser', quantity: 2, unitPrice: 75.00, total: 150.00 }
        ]
      },
      {
        id: '2',
        ...
        items: [
          { id: '2', productName: 'Hydrating Moisturizer', quantity: 1, unitPrice: 200.00, total: 200.00 }
        ]
      },
      {
        id: '3',
        ...
        items: [
          { id: '3', productName: 'Face Serum', quantity: 2, unitPrice: 150.00, total: 300.00 }
        ]
      }
    ];
