...
export default function Analytics() {
  ...
  const loadAnalyticsData = async () => {
    try {
      ...
      setChartData([
        { date: '2024-01-01', sessions: 120, revenue: 1200, orders: 4 },
        { date: '2024-01-02', sessions: 150, revenue: 1500, orders: 5 },
        { date: '2024-01-03', sessions: 180, revenue: 1800, orders: 6 },
        { date: '2024-01-04', sessions: 200, revenue: 2000, orders: 7 },
        { date: '2024-01-05', sessions: 220, revenue: 2200, orders: 8 },
        { date: '2024-01-06', sessions: 250, revenue: 2500, orders: 9 },
        { date: '2024-01-07', sessions: 280, revenue: 2800, orders: 10 }
      ])
    } finally {
      setLoading(false)
    }
