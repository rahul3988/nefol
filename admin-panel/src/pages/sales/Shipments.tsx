...
export default function Shipments() {
  ...
  useEffect(() => { 
    ...
    const unsubscribeShipmentCreated = socketService.subscribe('shipment_created', (newShipment) => {
      console.log('New shipment created:', newShipment)
      setShipments(prev => [newShipment, ...prev])
    })
    
    const unsubscribeShipmentUpdated = socketService.subscribe('shipment_updated', (updatedShipment) => {
