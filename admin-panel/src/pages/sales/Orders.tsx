...
export default function Orders() {
  ...
  useEffect(() => { 
    ...
    const unsubscribeOrderCreated = socketService.subscribe('order_created', (newOrder) => {
      console.log('New order received:', newOrder)
      setItems(prev => [newOrder, ...prev])
    })
    
    const unsubscribeOrderUpdated = socketService.subscribe('order_updated', (updatedOrder) => {
