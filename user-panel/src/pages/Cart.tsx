...
export default function Cart() {
  const { items, removeIndex, updateQuantity, clear, subtotal, tax, total } = useCart()
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <div className="space-y-4">
                  {items.map((item, index) => (
                    <div key={`${item.slug}-${index}`} className="flex items-center space-x-4 p-4 border border-slate-200 rounded-lg hover:shadow-md transition-shadow">
                      {/* Product Image */}
                        ...
                        <div className="relative">
                          <img
                            ...
                            onError={(e) => {
                              ...
                              if (target.src !== '/IMAGES/BANNER (1).jpg') {
                                target.src = '/IMAGES/BANNER (1).jpg'
                              } else if (target.src !== '/IMAGES/face.jpg') {
                                target.src = '/IMAGES/face.jpg'
                              } else if (target.src !== '/IMAGES/body.jpg') {
